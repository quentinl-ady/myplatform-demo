    ...
    <div class="fintech-wrapper">
      <div class="header-section">
        <div class="header-row">
          <div>
            <h2>Disputes</h2>
            <p>Track and manage chargebacks and disputes.</p>
          </div>
          <button mat-icon-button class="refresh-btn" (click)="refresh()" [disabled]="refreshing()" matTooltip="Refresh disputes">
...
export class DisputeComponent implements OnInit, OnDestroy {
    ...
    private disputesOverview: DisputesOverview | null = null;
    ...
    ngOnDestroy() {
        this.disputesOverview?.unmount();
        this.disputesOverview = null;
    }
    ...
    async refresh() {
        ...
        this.disputesOverview?.unmount();
        this.disputesOverview = null;
        const container = document.getElementById('disputes-overview-container');
    ...
    private async initAdyenComponents() {
        ...
        this.disputesOverview = new DisputesOverview({core});
        this.disputesOverview.mount('#disputes-overview-container');
    }
}
